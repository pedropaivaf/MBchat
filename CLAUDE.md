...
- Historico com busca em tempo real (tipo Ctrl+F, highlight amarelo) e filtro por data De/Até (dd/mm/aaaa), tanto no chat individual quanto no global (menu Ferramentas)
